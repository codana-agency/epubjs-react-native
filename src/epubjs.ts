              ...
              value: function () {
                ...
                for (
                  ...
                  (l.setAttribute("x1", a.left - i.left + n.left),
                    ...
                    l.setAttribute(
                      "stroke-width",
                      (attrs && attrs["stroke-width"]) || 1,
                    ),
                    l.setAttribute(
                      "stroke-opacity",
                      (attrs && attrs["stroke-opacity"]) || 0.3,
                    ),
                    l.setAttribute(
                      "stroke",
            ...
            4: [
              function (t, e, i) {
                ...
                function q(t, e) {
                  var i = t.name + "/";
                  return (
                    t.storeName !== e.storeName && (i += t.storeName + "/"),
                    i
                  );
                }
                function F() {
                        ...
                        return new o(function (s, r) {
                          ...
                          o.serializer.serialize(e, function (e, n) {
                            if (n) r(n);
                              ...
                              try {
                                (localStorage.setItem(o.keyPrefix + t, e),
                                  s(i));
                              } catch (t) {
                    ...
                    key: function (t, e) {
                      var i = this,
                        n = i.ready().then(function () {
                          ...
                          return (
                            e && (e = e.substring(n.keyPrefix.length)),
                            e
                          );
                        });
                      return (a(n, e), n);
                              ...
                              var e = function (t) {
                                  return function () {
                                    var e = new Error(
                                      ...
                                      i = o.reject(e);
                                    return (
                                      a(i, arguments[arguments.length - 1]),
                                      i
                                    );
                                  };
                                },
    ...
    function (t, e, i) {
      ...
      var f = class {
        ...
        search(t, e = 5) {
          ...
          for (; (a = o.nextNode()); )
            (h.push(a),
              h.length == e && (r(h.slice(0, e)), (h = h.slice(1, e))));
          ...
          switch (u) {
            ...
            case '"':
              if (3 === c || 1 === c) {
                ...
                (a(h, (d = t.slice(e, l).replace(/&#?\\w+;/g, r)), e - 1),
                  (c = 5));
              } else {
